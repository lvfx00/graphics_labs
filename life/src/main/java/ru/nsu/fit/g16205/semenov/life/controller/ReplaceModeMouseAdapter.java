...
public class ReplaceModeMouseAdapter extends MouseAdapter {
    private final FieldView fieldView;
    private final GameModel gameModel;
    private final MyFrame myFrame;

    public ReplaceModeMouseAdapter(FieldView fieldView, GameModel gameModel, MyFrame myFrame) {
    ...
    private void handleMouseEvent(MouseEvent e) {
        ...
        if (cell != null) {
            ...
            gameModel.setCell(cell.getX(), cell.getY(), true);
